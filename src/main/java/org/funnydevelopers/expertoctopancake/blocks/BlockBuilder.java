...
public class BlockBuilder {
    ...
    public BlockBuilder minX(double minX) {
        this.minX = minX;
        return this;
    }

    public BlockBuilder minY(double minY) {
        this.minY = minY;
        return this;
    }

    public BlockBuilder minZ(double minZ) {
        this.minZ = minZ;
        return this;
    }

    public BlockBuilder maxX(double maxX) {
        this.maxX = maxX;
        return this;
    }

    public BlockBuilder maxY(double maxY) {
        this.maxY = maxY;
        return this;
    }

    public BlockBuilder maxZ(double maxZ) {
        this.maxZ = maxZ;
        return this;
    }
